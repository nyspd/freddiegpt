...
export default function App() {
  ...
  const [messages, setMessages] = useState([
    ...
    { from: 'ai', text: 'Your current BTC value is $12,859. Gym today at 4:50pm. You’ve got $17,465 in savings. Let’s optimize.' }
  ]);
  ...
  const sendMessage = async () => {
    ...
    try {
      const prompt = `You are Freddie. Respond to this input as if you're FreddieGPT with full context of finances, goals, appearance, gym, mindset, and current life: "${input}"`;
  ...
  return (
    <div style={{
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: 10 }}>
        ...
        {loading && <div style={{ color: '#0f0' }}>FreddieGPT is thinking...</div>}
      </div>
